var _jsxFileName='lib/components/NatTextInput/NatTextInput.test.js';var _react=require('react');var _react2=_interopRequireDefault(_react);
...
var _NatTextInput=require('./NatTextInput');function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}

describe('TextInput component default',function(){
it('Should render textInput component ',function(){
var button=_reactTestRenderer2.default.create(
_react2.default.createElement(_NatTextInput.NatTextInput,{label:'teste',onChangeText:jest.fn(),__source:{fileName:_jsxFileName,lineNumber:11}})).
toJSON();
...
//# sourceMappingURL=NatTextInput.test.js.map