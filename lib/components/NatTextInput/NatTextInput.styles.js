Object.defineProperty(exports,"__esModule",{value:true});exports.IconPress=exports.AssistiveTexView=exports.Label=exports.TextInput=exports.InputWrapper=exports.Wrapper=undefined;var _jsxFileName='lib/components/NatTextInput/NatTextInput.styles.js';var _templateObject=_taggedTemplateLiteral(['\n  width: 100%;\n  margin-bottom: ','px;\n'],['\n  width: 100%;\n  margin-bottom: ','px;\n']),_templateObject2=_taggedTemplateLiteral(['\n  border: ',';\n  border-color: ',';\n  border-radius: 4px;\n  height: ',';\n  padding-left: 16px;\n  padding-bottom: 0px;\n  flex-direction: row;\n  justify-content: space-between;\n  background-color: ',';\n'],['\n  border: ',';\n  border-color: ',';\n  border-radius: 4px;\n  height: ',';\n  padding-left: 16px;\n  padding-bottom: 0px;\n  flex-direction: row;\n  justify-content: space-between;\n  background-color: ',';\n']),_templateObject3=_taggedTemplateLiteral(['\n  font-size: 16px;\n  flex: 7;\n  align-self: center;\n  padding-top: ',';\n  padding-bottom: ',';\n  text-align-vertical: top;\n  height: ',';\n  color: ',';\n  letter-spacing: ',';\n'],['\n  font-size: 16px;\n  flex: 7;\n  align-self: center;\n  padding-top: ',';\n  padding-bottom: ',';\n  text-align-vertical: top;\n  height: ',';\n  color: ',';\n  letter-spacing: ',';\n']),_templateObject4=_taggedTemplateLiteral(['\n  align-self: center;\n  flex: 1;\n'],['\n  align-self: center;\n  flex: 1;\n']);var _react=require('react');var _react2=_interopRequireDefault(_react);
...
var getPaddingSize=function getPaddingSize(multiline,size){
var finalSize=multiline>1?'16px':'16px';
...
function(_ref){var marginDefault=_ref.marginDefault;return _sizes.sizes[marginDefault];});
...
function(_ref6){var numberOfLines=_ref6.numberOfLines,size=_ref6.size;return getPaddingSize(numberOfLines,size);},
function(_ref7){var numberOfLines=_ref7.numberOfLines,size=_ref7.size;return getPaddingSize(numberOfLines,size);},
...
return _react2.default.createElement(_NatText.NatText,{value:text,type:'body2',color:color,margin:theme.spacing.spacingNone,__source:{fileName:_jsxFileName,lineNumber:93}});
};

var AssistiveTexView=exports.AssistiveTexView=function AssistiveTexView(_ref12)
...
return _react2.default.createElement(_NatText.NatText,{value:text,type:'caption',color:color,margin:theme.spacing.spacingNone,__source:{fileName:_jsxFileName,lineNumber:104}});
};
...
theme:_propTypes2.default.shape().isRequired,
type:_propTypes2.default.string.isRequired};
//# sourceMappingURL=NatTextInput.styles.js.map